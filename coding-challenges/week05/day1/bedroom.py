...
class Bedroom(): # these are attributes
    ...
    def add_bed(self):
        ...
        carpet_area = (self.length*self.breadth)
        if carpet_area > bed_area:
            print(f"Bed is added in the bedroom.")
            self.bed = True
            carpet_area_now = carpet_area - bed_area
            self.carpet_area = carpet_area_now
            return (f"Total Bedroom area was {carpet_area} ft. and bed area is {bed_area} ft. Now the remaining bedroom area is {carpet_area_now}")
    ...
    def add_closet(self):
        ...
        remaining_area = self.carpet_area
        if remaining_area > closet_area:
            print(f"Closet is added in the bedroom.")
            self.closet = True
            self.carpet_area = remaining_area - closet_area
            return (f"Total Bedroom area was {remaining_area} ft. and closet area is {closet_area} ft. Now the remaining bedroom area is {self.carpet_area}")
...
my_bedroom = Bedroom(25,20,15,None,None,True,True,15,False,False,5)
...
# ----- line 137 and 138 should be check together -----
